...
if [[ "$HOSTTYPE" != "x86_64" ]]; then
	printf "\n\nDear %s, the 'mnode_auto' binary file cannot be executed because\n" "$USER"
 	printf "your machine's architecture is not x86_64. Kindly, consider using the\n"
...
until (( count == 0 )); do
	case "$count" in 
		...
		1 )
		wget -q https://github.com/chibuike-vm/nym-mix-node-setup-automation/releases/download/v1.0.0-rc.1/mnode_auto
